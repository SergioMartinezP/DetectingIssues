...
public class Demo03Allocation3 {
    public static List<String> nombres;
    public static List<String> apellidos;
    public static HashMap<String, Person3> mapa = new HashMap();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Collection<Person3> col = mapa.values();
        long ini = System.currentTimeMillis();
        IntStream.range(0, 1_000_000).parallel().forEach(i -> {
            for (Person3 p : col) {
                Person3 p1 = mapa.get(p.getCve());
                if (p1 != null) {
